package com.basesoftware.cryptojava.architecture.mvp.model;
...
public class MVPRepository {
    ...
    @Inject
    public MVPRepository(CryptoAPI cryptoAPI, CryptoDao cryptoDao, CompositeDisposable compositeDisposable) {
